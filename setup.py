...
setup(
    ...
    author_email='burgholzer@me.com',
    description='A Template Repository for C++ Projects with Python Bindings',
    long_description=README,
    long_description_content_type="text/markdown",
    license="MIT",
    url="https://burgholzer.me",
    ext_modules=[CMakeExtension('pyproject', namespace='namespace.project.')],
    ...
    keywords="template",
    project_urls={
        'Source': 'https://github.com/burgholzer/template/',
        'Tracker': 'https://github.com/burgholzer/template/issues',
        # 'Research': ''
    }
)
